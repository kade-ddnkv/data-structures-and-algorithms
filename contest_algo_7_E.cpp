...
int getDamerauLevenshteinDistance(std::string first, std::string second) {
...
int main() {
    ...
    getline(std::cin, line_break);
    for (int i = 0; i < number_of_pairs; ++i) {
        std::cout << getDamerauLevenshteinDistance(readLine(), readLine()) << " ";
    }
    return 0;
}
